...
export default function HondaCity(){
    return(
        <div>
            ...
            <h1 className="underline text-3xl text-center font-bold">Honda City 2024 Price in Pakistan, Images, Reviews & Specs</h1>
            <div className="flex flex-col items-center">
            <img className="py-10" src="/Honda_City.jpg" height={350} width={350} alt="City" />
            ...
            <h1 className="text-green-400 text-3xl text-center my-12 font-bold">PKR 58,00,000</h1>
