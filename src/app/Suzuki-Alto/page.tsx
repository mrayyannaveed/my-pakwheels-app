...
export default function SuzukiAlto(){
    return(
        <div>
            ...
            <h1 className="underline text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-center font-bold">Suzuki Alto 2024 Price in Pakistan, Images, Reviews & Specs</h1>
            <div className="flex flex-col items-center">
            <img className="py-10" src="/Suzuki_Alto.jpg" height={350} width={350} alt="Alto" />
            ...
            <h1 className="text-green-400 text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-center my-12 font-bold">PKR 27,00,000</h1>
