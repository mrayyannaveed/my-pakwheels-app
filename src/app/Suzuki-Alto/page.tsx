...
export default function SuzukiAlto(){
    return(
        <div>
            ...
            <h1 className="underline text-3xl text-center font-bold">Suzuki Alto 2024 Price in Pakistan, Images, Reviews & Specs</h1>
            ...
            <h1 className="text-green-400 text-3xl text-center my-12 font-bold">PKR 27,00,000</h1>
