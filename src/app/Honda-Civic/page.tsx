...
export default function HondaCivic(){
    return(
        <div>
            ...
            <h1 className="underline text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-center font-bold">Honda Civic 2024 Price in Pakistan, Images, Reviews & Specs</h1>
            ...
            <h1 className="text-green-400 text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-center my-12 font-bold">PKR 99,00,000</h1>
