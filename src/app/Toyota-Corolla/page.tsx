...
export default function ToyotaCorolla(){
    return(
        <div>
            ...
            <h1 className="underline text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-center font-bold">Toyota Corolla 2024 Price in Pakistan, Images, Reviews & Specs</h1>
            <div className="flex flex-col items-center">
            <img className="py-10" src="/Toyota_Corolla.jpg" height={350} width={350} alt="corolla" />
            ...
            <h1 className="text-green-400 text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-center my-12 font-bold">PKR 70,00,000</h1>
