...
export default function ToyotaCorolla(){
    return(
        <div>
            ...
            <h1 className="underline text-3xl text-center font-bold">Toyota Corolla 2024 Price in Pakistan, Images, Reviews & Specs</h1>
            ...
            <h1 className="text-green-400 text-3xl text-center my-12 font-bold">PKR 70,00,000</h1>
            <div className="flex justify-center">
            <Link href="../Form">
            <button className="bg-blue-600 text-white px-8 py-5 rounded-md">Make Payment</button>
            </Link>
            </div>
            </div>
        </div>
